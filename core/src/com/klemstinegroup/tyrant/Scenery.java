...
public class Scenery {
	...
	private static class WellScript extends Script {
		...
		public boolean handle(Thing t, Event e) {
			...
			Game.selectItem("Select an item to drop in the well:",
					tt);
	  		Engine.instance.input = '7';
	...
	private static class AltarScript extends Script {
		...
		public boolean handle(Thing t, Event e) {
			...
			if ((altarReligion != null)
					&& (!altarReligion.equals(heroReligion))) {
			...
			Game.selectItem("Select an item to scrifice to " + heroReligion,
					h.getItems());
			Engine.instance.input = '6';
			Engine.instance.inputThing = t;
			return true;
		}
	}
	...
	private static class GraveStoneScript extends Script {
		...
		public boolean handle(Thing t, Event e) {
			...
			if (h.getFlag(Skill.LITERACY)) {
				...
				Game.message("You notice some inscriptions on "
						+ t.getTheName());
			}
			return false;
		}
