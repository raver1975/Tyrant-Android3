 ...
 * 
 */
public class BaseObject implements Cloneable, Serializable, Comparable {
	 ...
	 * - A Map 
	 */
	public transient ThingOwner place;
	...
	public Object get(String key) {
		...
		if (GET_SET_DEBUG) {
			...
			if (GET_OUTPUT_DEBUG) {
				StackTraceElement[] stackTrace = new RuntimeException("debug")
						.getStackTrace();
				String stack = "";
	...
	public int compareTo(Object arg0) {
		String a = ((String) this.get("Name"));
		String b = ((String) ((BaseObject) arg0).get("Name"));
