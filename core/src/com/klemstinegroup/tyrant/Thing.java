...
//	public TextureRegion getRegion(int src,Texture texture){
//		int i=getStat("Image");
//		int sx = (i % 20) * TILEWIDTH;
//		int sy = (i / 20) * TILEHEIGHT;
//		return new TextureRegion(texture,sx,sy,TILEWIDTH,TILEHEIGHT);
//	}
    ...
    public final boolean isHero() {
    	//return this.name()==Game.hero().name();
   ...
   public boolean isWielded(Thing item) {
	...
	public int notify(int eventtype, int ext, Thing o) {
