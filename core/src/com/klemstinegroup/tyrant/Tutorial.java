...
public class Tutorial {
	...
	public static Map buildLoft() {
		...
		m.addThing(
				Special.messagePoint("To the south of you is a chest. You can try to open it by running into it. It may be locked, in which case you will either need to break it open or find a way to unlock it. If you manage to open it and find an item inside, use \"Pick Up\" to pick it up.")
				,2,6
		);
	...
	public static Map buildCellar() {
		...
		if (h.getFlag(Skill.LITERACY)) {
			...
			m.addThing(
					Special.messagePoint("There is a note here on the ground. You can pick it up with the \"Pick Up\" command. Because you are have the Literacy skill, you can then use \"read\" to read it.")
					,3,3
			);
		}
		...
		m.addThing(
				Special.messagePoint("You can hear the scurrying of rats behind this door. Are you ready to fight? To prepare for battle, use \"equip\" to wield a weapon or wear armour. To attack an opponent, just run into it.")
				,7,11
		);
		for (int i=0; i<6; i++) {
		...
		m.addThing(
				Special.messagePoint("Sometimes there are hidden areas within dungeons. Use \"search\" to search your current surroundings.")
				,1,11
		);
		m.addThing(Lib.create("secret door"),1,12);
		m.addThing(
				Special.messagePoint("There is a potion lying here. Potions often have magical properties that can greatly assist you in your adventures. However, it is dangerous to drink unidentified potions because some of them may have nasty side effects. You can drink a potion with the \"drink\" command.")
				,1,7
		);
		...
		m.addThing(
				Special.messagePoint("If you become hungry during your adventures, you will need to find food. The item here can be eaten by picking it up and using \"eat\"")
				,3,14
		);
		...
		m.addThing(
				Special.messagePoint("Many items in TyrantAndroid have multiple uses. A bone for example, can be wielded as a weapon by using \"equip\". Alternatively, if you are feeling hungry you can eat it by using \"eat\".")
				,9,15
		);
		...
		m.addThing(
				Special.messagePoint("You hear something moving behind this door. Sounds like "+mon.getAName()+"! If you open the door, be ready to fight. Wield your weapons and wear armour by using \"equip\". In close combat, you can attack by simply running into the monster.")
				,11,3
		);
		m.addThing(mon,15,3);
		m.addThing(
				Special.messagePoint("This portcullis (to the south of you) can never be opened. It may be useful though, since you can always get a clear view of the room on the other side! Use \"look\" to look at a distant object.")
				,14,3
		);
		...
		for (int x=14; x<=22; x+=4) {
		    ...
		    if (th.equals("[IsChest]")) {
				m.addThing(
					Special.messagePoint("To the north of you is a chest. You can try to open it by running into it. It may be locked, in which case you will either need to break it open or find a way to unlock it. If you manage to open it and find an item inside, use \"Pick Up\" to pick it up.")
						,x,7
				);
		    }
		...
		m.addThing(
				Special.messagePoint("An item lies to the west, but be careful! It looks like a trap has been set. You can search for traps by using \"search\". If you have the disarm traps skill, you can attempt to disarm the trap by using \"skill\" to apply the Disarm Trap skill. Otherwise, you can risk stepping onto the trap if you dare....")
				,22,23
		);
		...
		m.addThing(
				Special.messagePoint("Some doors may be locked. You can unlock them if you have keys or lock picks and the Lockpicking skill. Otherwise, your best chance of getting through is kicking them down by using \"kick\".")
				,18,12
		);
	...
	public static Map buildTutorialMap() {
		...
		// mini temple
		{
			...
			m.addThing(
					Special.messagePoint("The people of North Karrain are highly religious, and altars can be found throughout the land. You can pray for divine assistance at any time with the \"pray\" command.")
					,x+2,y+2
			);
		}
		...
		m.addThing(
				Special.messagePoint("You can open the door automatically by running into it. You can also use the \"open\" command to open or close the door.")
				,15,10
		);
		...
		m.addThing(
				Special.messagePoint("You can talk to the people in the inn by standing next to them and using \"chat\". Many characters that you meet on your travels will be able to give you useful information or aid you in your quests in some way.")
				,13,10
		);
		
		m.addThing(
				Special.messagePoint("The door next to you is locked. You may be able to find a way to open it. You can kick down doors in dungeons with the \"kick\" command but the locals won't like you trying that around here!")
				,7,10
		);
		...
		m.addThing(
				Special.messagePoint("You can pick up and use this knife as a weapon. use \"pick\" to pick it up. Then use \"equip\" to wield it as a weapon.")
				,8,17
		);
		{
		...
		m.addThing(
				Special.messagePoint("Use \"exit\" to climb this ladder.")
				,8,15
		);
        ...
        m.addThing(
            ...
            "You can go to him and chat by using \"chat\"."),16,14);
		...
		m.addThing(
				Special.messagePoint("You see some stairs here heading down into a dark cellar. You can hear the sounds of rats scuttling below. Move onto the stairs and use \"exit\" if you want to venture into the dark cellar.")
				,12,16
		);
		...
		m.set("EnterMessageFirst",
			"Welcome!\n\n"+
			"The Tradepost Inn lies to your west, where friendly locals will be glad to give novices an introduction to the TyrantAndroid world. If you are already an experienced adventurer, you can leave this area and start adventuring by heading east.\n"+
			"\n"+
			"We hope you enjoy playing TyrantAndroid!"
		);
		addPeople(m);
    ...
    private static void addPeople(Map m) {
		...
		m.addThing(Lib.create("strange rock"),23,23);
		...
		m.addThing(
				Special.messagePoint("The robed gentleman next to you is a learned teacher. You can enhance your skills by training with him assuming that you have gained sufficient experience. If you chat to him with the \"chat\" command he will tell you whether you are able to enhance your skills. You can view your character's current skills and other useful information at any time by using  \"stats\".")
				,12,12
		);
